    ...
    <main class="grid grid-cols-1 md:grid-cols-5 my-2 w-full bg-white shadow-md rounded-lg overflow-hidden">
        <div class="bg-cover-image shadow-sm bg-center bg-cover px-6 py-16">
            <div class="w-3/4 mx-auto">
                <img
                    class="mx-auto animate__animated animate__<?php echo esc_attr( $options->calo_animation->elements->logo ); ?>"
                    src="<?php echo esc_url( json_decode( CALO_PATH )->framework_url ); ?>/assets/img/logo.png"
        ...
        <div class="col-span-4 mx-8 md:mx-16 my-12">
            ...
            <div class="flex items-center">
                ...
                <a href="<?php echo esc_url($url); ?>" target="_blank" class="text-sm inline-flex items-center leading-sm px-3 py-1 mb-4 ml-2 bg-primary-600 text-white rounded-full">
					...
					<?php echo esc_html__('Contact', 'calo') ?>
                </a>
            </div>
