	...
	<div class="md:grid md:grid-cols-12 md:gap-4">
		<div class="m-4 md:m-0 md:col-span-3">
			...
			<div class="shadow-md shadow-gray-200/50 rounded-md bg-white">
				...
				<div class="menus pt-2 pb-4">
					<div class="flex hover:bg-gray-100 cursor-pointer text-sm px-6 py-2">
						<i class="fas fa-tachometer-alt text-sky-400 mt-1"></i>
						<span class="ml-4 font-semibold">Dashboard</span>
					</div>
					<div class="flex hover:bg-gray-100 cursor-pointer text-sm px-6 py-2">
						<i class="fas fa-calendar text-sky-400 mt-1"></i>
						<span class="ml-4 font-semibold">My Event</span>
					</div>
					<div class="flex hover:bg-gray-100 cursor-pointer text-sm px-6 py-2">
						<i class="fas fa-border-all text-sky-400 mt-1"></i>
						<span class="ml-4 font-semibold">Integration</span>
					</div>
					<div class="flex hover:bg-gray-100 cursor-pointer text-sm px-6 py-2">
						<i class="fas fa-cog text-sky-400 mt-1"></i>
						<span class="ml-4 font-semibold">Setting</span>
					</div>
				</div>
			</div>
			<!-- End Profile -->
		...
		<div class="m-4 md:m-0 md:col-span-9">
			...
			<div class="shadow-md shadow-gray-200/50 rounded-md bg-white p-4 md:p-12">
				...
				<div class="bg-gray-50 px-8 py-6 rounded-md mb-12 flex flex-col md:block gap-y-4 md:gap-y-0">
					...
					<div class="flex">
						<i class="fas fa-calendar text-sky-400 mt-1"></i>
						<span class="ml-3">October 3, 2017 | 12:00PM -04:00AM</span>
					</div>
					<div class="flex">
						<i class="fas fa-map-marker-alt text-sky-400 mt-1"></i>
						<span class="ml-3">4140 Parker Rd. Allentown, New Mexico 31134</span>
					</div>
				</div>
